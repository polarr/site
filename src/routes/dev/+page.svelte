...
<div class="max-w-2xl py-8">
	...
	<P class="my-4" weight="light" color="text-gray-500 dark:text-gray-400">
		I have lots of experience with <Span underline>Fullstack Web Development</Span>: web frameworks, UI design, APIs, servers, auth, realtime, many DB paradigms, infrastructure design and more.
	</P>
	<P class="my-4" weight="light" color="text-gray-500 dark:text-gray-400">
	...
	<P class="my-4" weight="light" color="text-gray-500 dark:text-gray-400">
		I am broadly interested in <Span>Deep Learning</Span>.
	</P>
	...
	<P class="my-4" weight="light" color="text-gray-500 dark:text-gray-400">
		For fun, I have developed a variety of software projects. 
